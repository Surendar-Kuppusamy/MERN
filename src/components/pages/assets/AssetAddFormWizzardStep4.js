    ...
    return (
        <div>
            ...
            <div className="input-group mb-3">
                ...
                <Dropdown options={props.all_options.asset_length_width_options} onChange={e => props.onClickDMYTypes(e, 'asset_size_in_width_type', props.formikProps.values, props.formikProps.setFieldValue)} value={props.formikProps.values.asset_size_in_width_type} placeholder="Select unit" />
            ...
            <div className="input-group mb-3">
                ...
                <Dropdown options={props.all_options.asset_length_width_options} onChange={e => props.onClickDMYTypes(e, 'asset_size_in_length_type', props.formikProps.values, props.formikProps.setFieldValue)} value={props.formikProps.values.asset_size_in_length_type} placeholder="Select unit" />
