    ...
    return (
        <div>
            ...
            <div className="input-group">    
                ...
                <Dropdown options={props.all_options.days_month_years_options} onChange={e => props.onClickDMYTypes(e, 'age_of_asset_type', props.formikProps.values, props.formikProps.setFieldValue)} value={props.formikProps.values.age_of_asset_type} placeholder="Select period type" />
            </div>
            <div className="mt-n2 mb-3">
